...
#define MyAppName "Tor Player"
#define MyAppExeName "tor_player.exe"

[Setup]
; NOTE: The value of AppId uniquely identifies this application. Do not use the same AppId value in installers for other applications.
; (To generate a new GUID, click Tools | Generate GUID inside the IDE.)
AppId={{8D034561-53F0-4FE8-86E4-D71EEA95B6B0}
AppName={#MyAppName}
...
OutputBaseFilename=TorPlayer_{#MyAppVersion}_Installer
...
Source: "{#WorkingDir}\build\windows\x64\runner\Release\desktop_drop_plugin.dll"; DestDir: "{app}"; Flags: ignoreversion
...
Source: "{#WorkingDir}\build\windows\x64\runner\Release\data\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
