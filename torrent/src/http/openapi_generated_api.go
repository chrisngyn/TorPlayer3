...
type ServerInterface interface {
	...
	// Cancel torrent
	// (POST /torrents/{infoHash}/cancel)
	CancelTorrent(w http.ResponseWriter, r *http.Request, infoHash InfoHash)
	// Delete torrent
	// (DELETE /torrents/{infoHash}/delete)
	DeleteTorrent(w http.ResponseWriter, r *http.Request, infoHash InfoHash)
	// Start download torrent
	// (POST /torrents/{infoHash}/download)
	DownloadTorrent(w http.ResponseWriter, r *http.Request, infoHash InfoHash)
	// Get torrent file stats
	// (GET /torrents/{infoHash}/files/{fileIndex}/stats)
	GetTorrentFileStats(w http.ResponseWriter, r *http.Request, infoHash InfoHash, fileIndex FileIndex)
	// Stream file
	...
	GetTorrentStats(w http.ResponseWriter, r *http.Request, infoHash InfoHash)
}
...
// Cancel torrent
// (POST /torrents/{infoHash}/cancel)
func (_ Unimplemented) CancelTorrent(w http.ResponseWriter, r *http.Request, infoHash InfoHash) {
	w.WriteHeader(http.StatusNotImplemented)
}
...
// Start download torrent
// (POST /torrents/{infoHash}/download)
func (_ Unimplemented) DownloadTorrent(w http.ResponseWriter, r *http.Request, infoHash InfoHash) {
	w.WriteHeader(http.StatusNotImplemented)
}

// Get torrent file stats
// (GET /torrents/{infoHash}/files/{fileIndex}/stats)
func (_ Unimplemented) GetTorrentFileStats(w http.ResponseWriter, r *http.Request, infoHash InfoHash, fileIndex FileIndex) {
	w.WriteHeader(http.StatusNotImplemented)
}
...
// Get torrent stats
// (GET /torrents/{infoHash}/stats)
func (_ Unimplemented) GetTorrentStats(w http.ResponseWriter, r *http.Request, infoHash InfoHash) {
	w.WriteHeader(http.StatusNotImplemented)
}
...
// CancelTorrent operation middleware
func (siw *ServerInterfaceWrapper) CancelTorrent(w http.ResponseWriter, r *http.Request) {
	ctx := r.Context()
	...
	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.CancelTorrent(w, r, infoHash)
	}))
...
// DownloadTorrent operation middleware
func (siw *ServerInterfaceWrapper) DownloadTorrent(w http.ResponseWriter, r *http.Request) {
	ctx := r.Context()
	...
	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.DownloadTorrent(w, r, infoHash)
	}))
...
// GetTorrentFileStats operation middleware
func (siw *ServerInterfaceWrapper) GetTorrentFileStats(w http.ResponseWriter, r *http.Request) {
	ctx := r.Context()
	...
	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.GetTorrentFileStats(w, r, infoHash, fileIndex)
	}))
...
func (siw *ServerInterfaceWrapper) GetTorrentStats(w http.ResponseWriter, r *http.Request) {
	...
	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.GetTorrentStats(w, r, infoHash)
	}))
...
func HandlerWithOptions(si ServerInterface, options ChiServerOptions) http.Handler {
	...
	r.Group(func(r chi.Router) {
		r.Post(options.BaseURL+"/torrents/{infoHash}/cancel", wrapper.CancelTorrent)
	})
	r.Group(func(r chi.Router) {
		r.Delete(options.BaseURL+"/torrents/{infoHash}/delete", wrapper.DeleteTorrent)
	})
	r.Group(func(r chi.Router) {
		r.Post(options.BaseURL+"/torrents/{infoHash}/download", wrapper.DownloadTorrent)
	})
	r.Group(func(r chi.Router) {
		r.Get(options.BaseURL+"/torrents/{infoHash}/files/{fileIndex}/stats", wrapper.GetTorrentFileStats)
	})
	r.Group(func(r chi.Router) {
		r.Get(options.BaseURL+"/torrents/{infoHash}/files/{fileIndex}/stream/{fileName}", wrapper.StreamFile)
	})
	r.Group(func(r chi.Router) {
		r.Get(options.BaseURL+"/torrents/{infoHash}/stats", wrapper.GetTorrentStats)
	})
